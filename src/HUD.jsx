  ...
  return (
    <div className="hud">
      <div>
        ...
        <div className="hud-panel" style={{backgroundImage: "url('/ui/button_rectangle_flat.png')"}}>
        ...
        <div className="hud-panel" style={{backgroundImage: "url('/ui/button_rectangle_flat.png')"}}>
          ...
          {ragePoints >= 100 && !rageMode && (
            <button 
              ...
              style={{backgroundImage: "url('/ui/button_rectangle_depth_gradient.png')"}}
            >
              <img 
                src="/ui/star.png" 
                alt="Rage" 
